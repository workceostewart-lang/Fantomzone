...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Do(e,t,n){let r=new Float32Array(po),i=new K(0,1,0);return new Wi({name:`SphericalGaussianBlur`,defines:{n:po,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ao(),fragmentShader:`
	...
	`}var jo=class extends Pt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ti(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`;var Fl=new class{constructor(){this.context=null,this.lastCollision=0}tone(e,t=.08,n=`sine`,r=.035,i=0){if(!$.sound)return;this.context||=new AudioContext;let a=this.context.currentTime+i,o=this.context.createOscillator(),s=this.context.createGain();o.type=n,o.frequency.setValueAtTime(e,a),s.gain.setValueAtTime(r,a),s.gain.exponentialRampToValueAtTime(1e-4,a+t),o.connect(s).connect(this.context.destination),o.start(a),o.stop(a+t)}click(){this.tone(360,.045,`square`,.02)}strike(e){this.tone(120+e*.8,.1,`triangle`,.065),this.tone(72,.16,`sine`,.025,.015)}collide(e=1){let t=performance.now();t-this.lastCollision<42||(this.lastCollision=t,this.tone(620+Math.min(e,8)*42,.035,`sine`,.016))}rail(){this.tone(185,.05,`triangle`,.017)}pocket(){this.tone(90,.14,`sine`,.055),this.tone(55,.2,`triangle`,.025,.035)}win(){[392,523,659,784].forEach((e,t)=>this.tone(e,.22,`triangle`,.045,t*.085))}};function Il(){localStorage.setItem(Nl,JSON.stringify({sound:$.sound,wins:$.wins,matches:$.matches,longestRun:$.longestRun,difficulty:$.difficulty,raceTo:$.raceTo}))}function Ll(){document.querySelectorAll(`[data-sound-icon]`).forEach(e=>{e.textContent=$.sound?`♪`:`×`})}var Rl;function zl(e){let t=document.querySelector(`[data-toast]`);t.textContent=e,t.classList.add(`visible`),clearTimeout(Rl),Rl=setTimeout(()=>t.classList.remove(`visible`),2500)}var Bl={0:16249567,1:16238900,2:2058454,3:14893623,4:7161258,5:15894319,6:2071657,7:8267318,8:1120295,9:16238900,10:2058454,11:14893623,12:7161258,13:15894319,14:2071657,15:8267318};function Vl(e,t){let n=document.createElement(`canvas`);n.width=256,n.height=256;let r=n.getContext(`2d`);r.clearRect(0,0,256,256),e>8?(r.fillStyle=`#f8f3df`,r.fillRect(0,0,256,256),r.fillStyle=`#${t.toString(16).padStart(6,`0`)}`,r.fillRect(0,64,256,128)):(r.fillStyle=`#${t.toString(16).padStart(6,`0`)}`,r.fillRect(0,0,256,256)),e!==0&&(r.fillStyle=`#fffdf5`,r.beginPath(),r.arc(128,128,58,0,Math.PI*2),r.fill(),r.fillStyle=`#101725`,r.font=`900 74px Arial`,r.textAlign=`center`,r.textBaseline=`middle`,r.fillText(String(e),128,132));let i=new Ei(n);return i.colorSpace=We,i.anisotropy=4,i}function Hl(e){let t=Bl[e],n=new fn,r=new ri(new Pi(Q.ballRadius,30,20),new Ki({color:t,roughness:.3,metalness:.03}));if(r.castShadow=!0,r.receiveShadow=!0,n.add(r),e>8){let e=new ri(new Fi(Q.ballRadius*.72,Q.ballRadius*.42,12,32),new Ki({color:16315359,roughness:.32}));e.rotation.x=Math.PI/2,n.add(e)}if(e!==0){let r=new Fr(new xr({map:Vl(e,t),transparent:!0,depthTest:!1}));r.scale.set(13,13,1),r.position.y=Q.ballRadius+1.5,n.add(r)}return n}function Ul(e,t,n,r,i=24){let a=new ri(new Ai(t.x,i,t.y),new Ki({color:r,roughness:.55,metalness:.04}));return a.position.set(n.x,n.y,n.z),a.castShadow=!0,a.receiveShadow=!0,e.add(a),a}function Wl(e){Ul(e,{x:1050,y:570},{x:0,y:-22,z:0},5974040,38),Ul(e,{x:1018,y:538},{x:0,y:-4,z:0},12413487,23),Ul(e,{x:960,y:480},{x:0,y:5,z:0},752213,10);let t=new Ki({color:8140062,roughness:.5});[[0,17,-250,884,27],[0,17,250,884,27],[-490,17,0,27,404],[490,17,0,27,404]].forEach(([n,r,i,a,o])=>{let s=new ri(new Ai(a,24,o),t);s.position.set(n,r,i),s.castShadow=!0,e.add(s)}),[[-480,-240],[0,-240],[480,-240],[-480,240],[0,240],[480,240]].forEach(([t,n])=>{let r=new ri(new ji(29,34,8,40),new Ki({color:198410,roughness:.9}));r.position.set(t,13,n),e.add(r)}),[-360,-240,-120,120,240,360].forEach(t=>{[-268,268].forEach(n=>{let r=new ri(new ji(2.3,2.3,2,12),new Ki({color:16173132}));r.position.set(t,30,n),e.add(r)})})}function Gl(e,t,n){let r=new hl({canvas:e,antialias:!0,alpha:!0,powerPreference:`high-performance`});return r.outputColorSpace=We,r.shadowMap.enabled=!0,r.shadowMap.type=1,{renderer:r,resize:()=>{let t=e.getBoundingClientRect(),i=Math.max(1,Math.floor(t.width)),a=Math.max(1,Math.floor(t.height)),o=Math.min(window.devicePixelRatio||1,2);(e.width!==i*o||e.height!==a*o)&&(r.setPixelRatio(o),r.setSize(i,a,!1),n.isPerspectiveCamera&&(n.aspect=i/a,n.updateProjectionMatrix()))},scene:t,camera:n}}function Kl(){let e=document.querySelector(`#menu-canvas`),t=new xn;t.fog=new bn(399141,.0019);let n=new Ta(38,1,.1,2200);n.position.set(210,470,620),n.lookAt(80,0,0);let r=new pa(9886207,598041,2.4);t.add(r);let i=new Aa(16771260,4.2);i.position.set(-280,500,300),i.castShadow=!0,t.add(i);let a=new Da(2590719,95,900);a.position.set(400,130,-190),t.add(a);let o=new fn;t.add(o),Wl(o),o.rotation.y=-.1,o.position.set(115,-44,-60);let s=[0,1,2,3,4,5,6,8,9,10,11,12,13,14,15].map((e,t)=>{let n=Hl(e),r=Math.floor(t/5),i=t%5;return n.position.set(80+r*26+i*2,24,(i-2)*26+r*10),o.add(n),n}),c=new ri(new ji(3,5,470,14),new Ki({color:15386762,roughness:.42}));c.rotation.z=Math.PI/2,c.rotation.x=-.22,c.position.set(-160,68,112),o.add(c);let l=Gl(e,t,n),u=0,d=e=>{requestAnimationFrame(d),l.resize(),u=e*25e-5,o.rotation.y=-.1+Math.sin(u)*.012,s.forEach((e,t)=>{e.rotation.x+=t%3*7e-4,e.rotation.z+=5e-4}),l.renderer.render(t,n)};requestAnimationFrame(d)}var ql,Jl,Yl=[],Xl,Zl,Ql,$l,eu=performance.now(),tu,nu=!1,ru=[{x:Q.inset,y:Q.inset},{x:Q.width/2,y:Q.inset},{x:Q.width-Q.inset,y:Q.inset},{x:Q.inset,y:Q.height-Q.inset},{x:Q.width/2,y:Q.height-Q.inset},{x:Q.width-Q.inset,y:Q.height-Q.inset}];function iu(e,t=19){return new K(e.x-Q.width/2,t,e.y-Q.height/2)}function au(e){if(!Jl)return null;let t=Jl.renderer.domElement.getBoundingClientRect(),n=new G((e.clientX-t.left)/t.width*2-1,-((e.clientY-t.top)/t.height)*2+1),r=new Ja;r.setFromCamera(n,Jl.camera);let i=new K;return r.ray.intersectPlane(new ui(new K(0,1,0),-18),i)?{x:i.x+Q.width/2,y:i.z+Q.height/2}:null}function ou(e,t=!1){let n=new Ci(new hr().setFromPoints([new K,new K]),t?new Yi({color:e,dashSize:12,gapSize:8,linewidth:3,transparent:!0,opacity:.95}):new hi({color:e,transparent:!0,opacity:.95}));return n.visible=!1,n.renderOrder=8,Jl.scene.add(n),n}function su(e,t){if(!t||t.length<2){e.visible=!1;return}e.geometry.dispose(),e.geometry=new hr().setFromPoints(t.map(e=>iu(e,24))),e.computeLineDistances(),e.visible=!0}function cu(e,t,n,r){let i=e.x-n.x,a=e.y-n.y,o=-(i*t.x+a*t.y);if(o<=0)return null;let s=i*i+a*a-o*o,c=r*r;return s>c?null:o-Math.sqrt(c-s)}function lu(e,t){let n={left:Q.inset+Q.ballRadius,right:Q.width-Q.inset-Q.ballRadius,top:Q.inset+Q.ballRadius,bottom:Q.height-Q.inset-Q.ballRadius},r=[{...e}],i={...e},a={...t},o=[],s=null;for(let e=0;e<=3;e+=1){let t=a.x>0?(n.right-i.x)/a.x:a.x<0?(n.left-i.x)/a.x:1/0,c=a.y>0?(n.bottom-i.y)/a.y:a.y<0?(n.top-i.y)/a.y:1/0,l=Math.min(t,c),u=null;if(Yl.forEach(e=>{if(e.number===0||e.potted)return;let t=cu(i,a,e.body.position,Q.ballRadius*2.05);t!==null&&t<l&&t>1&&(!u||t<u.distance)&&(u={entry:e,distance:t})}),u){s={x:i.x+a.x*u.distance,y:i.y+a.y*u.distance},r.push(s);let e=u.entry.body.position,t={x:e.x-s.x,y:e.y-s.y},c=Math.hypot(t.x,t.y)||1;t.x/=c,t.y/=c;let l=Math.min(t.x>0?(n.right-e.x)/t.x:(n.left-e.x)/t.x,t.y>0?(n.bottom-e.y)/t.y:(n.top-e.y)/t.y),d=Math.min(155,Math.abs(l));o=[{x:e.x,y:e.y},{x:e.x+t.x*d,y:e.y+t.y*d}];break}let d={x:vl(i.x+a.x*l,n.left,n.right),y:vl(i.y+a.y*l,n.top,n.bottom)};if(r.push(d),e===3)break;Math.abs(t-l)<.001&&(a={...a,x:-a.x}),Math.abs(c-l)<.001&&(a={...a,y:-a.y}),i={x:d.x+a.x*.01,y:d.y+a.y*.01}}return{points:r,objectPath:o,impact:s}}function uu(){let e=Yl.find(e=>e.number===0&&!e.potted);if(!e||!$.aiming){Xl&&(Xl.visible=!1),Zl&&(Zl.visible=!1),Ql&&(Ql.visible=!1),$l&&($l.visible=!1);return}let t=lu(e.body.position,$.direction);su(Xl,t.points),su(Zl,t.objectPath),t.impact?(Ql.position.copy(iu(t.impact,25)),Ql.visible=!0):Ql.visible=!1;let n=Math.atan2($.direction.y,$.direction.x),r=145+$.power*.55;$l.position.copy(iu({x:e.body.position.x-$.direction.x*r,y:e.body.position.y-$.direction.y*r},33)),$l.rotation.y=-n,$l.visible=!0,document.querySelector(`[data-angle-value]`).textContent=String(wl($.direction))}function du(){if(Jl)return;let e=document.querySelector(`#table-canvas`),t=new xn;t.background=new Y(399394);let n=new Oa(-540,540,300,-300,1,1400);n.position.set(0,780,.01),n.lookAt(0,0,0),t.add(new pa(13103103,598291,2.7));let r=new Aa(16772549,3.6);r.position.set(-280,580,260),r.castShadow=!0,r.shadow.mapSize.set(1024,1024),r.shadow.camera.left=-560,r.shadow.camera.right=560,r.shadow.camera.top=320,r.shadow.camera.bottom=-320,t.add(r);let i=new Da(2985215,42,780);i.position.set(450,120,-250),t.add(i),Wl(t),Jl=Gl(e,t,n),Xl=ou(16777215,!0),Zl=ou(16173132,!1),Ql=new ri(new Ni(14,18,32),new Gr({color:16173132,transparent:!0,opacity:.95,side:2})),Ql.rotation.x=-Math.PI/2,Ql.visible=!1,Ql.renderOrder=9,t.add(Ql),$l=new ri(new ji(3.1,5.1,270,12),new Ki({color:15255177,roughness:.38})),$l.rotation.z=Math.PI/2,$l.castShadow=!0,$l.visible=!1,t.add($l),e.addEventListener(`pointerdown`,bu),e.addEventListener(`pointermove`,xu),e.addEventListener(`pointerup`,Cu),e.addEventListener(`pointercancel`,wu);let a=e=>{requestAnimationFrame(a),Jl.resize();let r=vl(e-eu,8,32);if(eu=e,ql){let e=Math.ceil(r/16.667);for(let t=0;t<e;t+=1)Al.update(ql,r/e),vu();hu(),mu(),_u()}uu(),Jl.renderer.render(t,n)};requestAnimationFrame(a)}function fu(){ql&&Al.clear(ql),Yl.forEach(e=>{e.mesh.removeFromParent(),e.mesh.traverse(e=>{e.geometry?.dispose?.(),e.material?.map&&e.material.map.dispose(),e.material?.dispose?.()})}),Yl=[],ql=Al.create({gravity:{x:0,y:0,scale:0}}),ql.positionIterations=12,ql.velocityIterations=10;let e={isStatic:!0,restitution:.92,friction:.02,label:`rail`},t=[Dl.rectangle(Q.width/2,29,Q.width-108,25,e),Dl.rectangle(Q.width/2,Q.height-29,Q.width-108,25,e),Dl.rectangle(29,Q.height/2,25,Q.height-108,e),Dl.rectangle(Q.width-29,Q.height/2,25,Q.height-108,e)];kl.add(ql.world,t);let n={x:264,y:Q.height/2};pu(0,n.x,n.y);let r=Sl();Cl().forEach((e,t)=>{pu(r[t],e.x,e.y)}),jl.on(ql,`collisionStart`,e=>{e.pairs.forEach(e=>{let t=Yl.find(t=>t.body===e.bodyA),n=Yl.find(t=>t.body===e.bodyB);if(t&&n){let e=Math.max(t.body.speed,n.body.speed);Fl.collide(e),!$.firstHit&&(t.number===0||n.number===0)&&($.firstHit=t.number===0?n.number:t.number,nu=!0)}else(t||n)&&Math.max(e.bodyA.speed,e.bodyB.speed)>1.2&&Fl.rail()})}),jl.on(ql,`collisionEnd`,()=>{nu=!1})}function pu(e,t,n){let r=Dl.circle(t,n,Q.ballRadius,{label:`ball-${e}`,restitution:.965,friction:.003,frictionAir:.0125,density:.002,slop:.05}),i=Hl(e);Jl.scene.add(i),Yl.push({number:e,body:r,mesh:i,potted:!1}),kl.add(ql.world,r)}function mu(){Yl.forEach(e=>{e.potted||(e.mesh.position.copy(iu(e.body.position,Q.ballRadius+17)),e.body.speed>.02&&(e.mesh.rotation.z-=e.body.velocity.x*.018,e.mesh.rotation.x+=e.body.velocity.y*.018))})}function hu(){Yl.forEach(e=>{e.potted||ru.find(t=>Math.hypot(e.body.position.x-t.x,e.body.position.y-t.y)<Q.pocketRadius)&&(e.potted=!0,e.mesh.visible=!1,kl.remove(ql.world,e.body),Fl.pocket(),e.number===0?($.shotPotted.push(0),zl(`Scratch • Cue ball returns after the shot`)):($.shotPotted.push(e.number),$.currentRun+=1,$.longestRun=Math.max($.longestRun,$.currentRun),e.number===8&&Au()),Nu())})}function gu(){return Yl.filter(e=>!e.potted).every(e=>e.body.speed<.085)}function _u(){if(!(!$.ballsMoving||$.gameOver)){if(!gu()){$.settling=!1;return}$.settling||($.settling=!0,setTimeout(()=>{$.ballsMoving&&gu()&&!$.gameOver&&ku(),$.settling=!1},320))}}function vu(){if($.spinFrames<=0)return;let e=Yl.find(e=>e.number===0&&!e.potted);if(!e||e.body.speed<.15){$.spinFrames=0;return}let t=Math.hypot(e.body.velocity.x,e.body.velocity.y)||1,n={x:-e.body.velocity.y/t,y:e.body.velocity.x/t},r=$.spin.x*9e-6*Math.min(e.body.speed,12);if(Ol.applyForce(e.body,e.body.position,{x:n.x*r,y:n.y*r}),nu&&$.spin.y!==0){let t=1+$.spin.y*.0018;Ol.setVelocity(e.body,{x:e.body.velocity.x*t,y:e.body.velocity.y*t})}--$.spinFrames}function yu(){return!($.gameOver||$.ballsMoving||$.aiming||$.mode===`cpu`&&$.currentPlayer===1)}function bu(e){if(!yu())return;let t=au(e),n=Yl.find(e=>e.number===0&&!e.potted);!t||!n||(e.currentTarget.setPointerCapture?.(e.pointerId),$.aiming=!0,$.power=0,Su(t),document.querySelector(`[data-turn-banner]`).classList.add(`aiming`))}function xu(e){if(!$.aiming)return;let t=au(e);t&&Su(t)}function Su(e){let t=Yl.find(e=>e.number===0&&!e.potted);if(!t)return;let n={x:t.body.position.x-e.x,y:t.body.position.y-e.y},r=Math.hypot(n.x,n.y);r>2&&($.direction={x:n.x/r,y:n.y/r}),$.power=Math.round(vl(r/190*100,0,100)),document.querySelector(`[data-power-value]`).textContent=String($.power),document.querySelector(`[data-power-fill]`).style.height=`${$.power}%`}function Cu(e){if(!$.aiming)return;e.currentTarget.releasePointerCapture?.(e.pointerId),document.querySelector(`[data-turn-banner]`).classList.remove(`aiming`);let t=$.power;if($.aiming=!1,t<4){$.power=0,document.querySelector(`[data-power-value]`).textContent=`0`,document.querySelector(`[data-power-fill]`).style.height=`0%`;return}Tu($.direction,t)}function wu(){$.aiming=!1,$.power=0,document.querySelector(`[data-power-value]`).textContent=`0`,document.querySelector(`[data-power-fill]`).style.height=`0%`}function Tu(e,t){let n=Yl.find(e=>e.number===0&&!e.potted);if(!n||$.ballsMoving||$.gameOver)return;clearTimeout(tu),$.aiming=!1,$.shotPotted=[],$.firstHit=null,$.power=t,$.shotNumber+=1,$.spinFrames=115,$.ballsMoving=!0,$.settling=!1;let r=5.1+t*.195;Ol.setVelocity(n.body,{x:e.x*r,y:e.y*r}),Fl.strike(t),document.querySelector(`[data-shot-number]`).textContent=String($.shotNumber).padStart(2,`0`),document.querySelector(`[data-table-status]`).textContent=`BALLS IN MOTION`,document.querySelector(`[data-turn-banner]`).textContent=`SHOT PLAYING`,document.querySelector(`[data-power-value]`).textContent=`0`,document.querySelector(`[data-power-fill]`).style.height=`0%`}function Eu(e){return Yl.filter(t=>!t.potted&&yl(t.number)===e).length}function Du(){if($.breakShot||$.groups[0]||$.groups[1])return;let e=$.shotPotted.find(e=>yl(e));if(!e)return;let t=yl(e);$.groups[$.currentPlayer]=t,$.groups[1-$.currentPlayer]=El(t),zl(`${$.currentPlayer===0?`Player 1`:`Player 2`} takes ${t}`)}function Ou(){let e=Yl.find(e=>e.number===0);e?.potted&&(e.potted=!1,e.mesh.visible=!0,Ol.setPosition(e.body,{x:264,y:Q.height/2}),Ol.setVelocity(e.body,{x:0,y:0}),kl.add(ql.world,e.body))}function ku(){$.ballsMoving=!1;let e=$.breakShot;$.breakShot=!1,Ou(),e||Du();let t=$.groups[$.currentPlayer];!($.mode===`solo`||e&&$.shotPotted.some(e=>yl(e))||$.shotPotted.some(e=>yl(e)===t))&&$.mode!==`solo`&&($.currentRun=0,$.currentPlayer=1-$.currentPlayer),e&&zl(`Table open • First legal pot claims a group`),$.power=0,Pu(),$.mode===`cpu`&&$.currentPlayer===1&&ju()}function Au(){let e=Tl({pottedNumber:8,playerGroup:$.groups[$.currentPlayer],remainingGroupBalls:Eu($.groups[$.currentPlayer])}),t=e===`win`?$.currentPlayer:1-$.currentPlayer;$.wins[t]+=1,$.matches+=1,$.gameOver=!0,$.ballsMoving=!1,Il(),Fl.win();let n=document.querySelector(`[data-result-card]`);n.hidden=!1,document.querySelector(`[data-result-kicker]`).textContent=e===`win`?`CLEAN FINISH`:`EARLY EIGHT`,document.querySelector(`[data-result-title]`).textContent=$.mode===`solo`?e===`win`?`TABLE CLEARED`:`RACK ENDED`:`${t===0?`PLAYER 1`:$.mode===`cpu`?`CPU`:`PLAYER 2`} WINS`,document.querySelector(`[data-result-copy]`).textContent=e===`win`?`The eight dropped on a legal table. Champion work.`:`The eight went early. Re-rack and read the finish.`,Pu()}function ju(){clearTimeout(tu),document.querySelector(`[data-table-status]`).textContent=`CPU READING TABLE`,document.querySelector(`[data-turn-banner]`).textContent=`CPU AIMING`;let e={easy:1050,medium:850,hard:680}[$.difficulty];tu=setTimeout(()=>{if($.currentPlayer!==1||$.gameOver||$.ballsMoving)return;let e=Yl.find(e=>e.number===0&&!e.potted),t=$.groups[1],n=Yl.filter(e=>!e.potted&&e.number!==0&&e.number!==8);if(t&&(n=n.filter(e=>yl(e.number)===t)),t&&Eu(t)===0&&(n=Yl.filter(e=>!e.potted&&e.number===8)),!e||!n.length)return;n.sort((t,n)=>Math.hypot(t.body.position.x-e.body.position.x,t.body.position.y-e.body.position.y)-Math.hypot(n.body.position.x-e.body.position.x,n.body.position.y-e.body.position.y));let r=n[0],i=Math.atan2(r.body.position.y-e.body.position.y,r.body.position.x-e.body.position.x),a={easy:.14,medium:.065,hard:.018}[$.difficulty],o=i+(Math.random()-.5)*a;$.direction={x:Math.cos(o),y:Math.sin(o)},$.spin={x:(Math.random()-.5)*.6,y:.2},Tu($.direction,{easy:48,medium:58,hard:66}[$.difficulty])},e)}function Mu(e){return e===_l.SOLIDS?`SOLIDS 1–7`:e===_l.STRIPES?`STRIPES 9–15`:`OPEN TABLE`}function Nu(){let e=document.querySelector(`[data-ball-tray]`);e.innerHTML=Array.from({length:15},(e,t)=>t+1).map(e=>`<span class="tray-ball ball-${e} ${Yl.find(t=>t.number===e)?.potted?`potted`:``}">${e}</span>`).join(``)}function Pu(){let e={solo:[`SOLO PRACTICE`,`YOUR TABLE`],cpu:[`VERSUS CPU`,$.currentPlayer===0?`YOUR TURN`:`CPU TURN`],multiplayer:[`MULTIPLAYER`,$.currentPlayer===0?`PLAYER 1 TURN`:`PLAYER 2 TURN`]};document.querySelector(`[data-mode-label]`).textContent=e[$.mode][0],document.querySelector(`[data-turn-label]`).textContent=e[$.mode][1],document.querySelector(`[data-player-two-name]`).textContent=$.mode===`cpu`?`CPU RIVAL`:`PLAYER 2`,document.querySelector(`[data-player-one-group]`).textContent=Mu($.groups[0]),document.querySelector(`[data-player-two-group]`).textContent=Mu($.groups[1]),document.querySelector(`[data-player-one-score]`).textContent=`P1  ${$.wins[0]}`,document.querySelector(`[data-player-two-score]`).textContent=`${$.mode===`cpu`?`CPU`:`P2`}  ${$.wins[1]}`,document.querySelectorAll(`[data-player-card]`).forEach((e,t)=>{e.classList.toggle(`active`,t===$.currentPlayer)}),document.querySelector(`[data-table-status]`).textContent=$.breakShot?`BREAK THE RACK`:$.mode===`solo`?`PRACTICE TABLE`:$.currentPlayer===1&&$.mode===`cpu`?`CPU READING TABLE`:`LINE UP YOUR SHOT`,document.querySelector(`[data-turn-banner]`).textContent=$.mode===`cpu`&&$.currentPlayer===1?`CPU AIMING`:$.mode===`solo`?`FREE PLAY`:`YOUR SHOT`,Nu()}function Fu(e,t={}){$.mode=e,$.difficulty=t.difficulty||$.difficulty,$.raceTo=t.raceTo||$.raceTo,$.currentPlayer=0,$.groups=[null,null],$.breakShot=!0,$.shotNumber=0,$.shotPotted=[],$.currentRun=0,$.gameOver=!1,$.ballsMoving=!1,$.aiming=!1,$.spin={x:0,y:0},document.querySelector(`[data-result-card]`).hidden=!0,document.querySelector(`[data-shot-number]`).textContent=`01`,document.querySelector(`[data-view='menu']`).hidden=!0,document.querySelector(`[data-view='game']`).hidden=!1,Bu(),du(),fu(),Pu(),Vu(),Il(),requestAnimationFrame(()=>Jl.resize())}function Iu(){clearTimeout(tu),$.aiming=!1,$.ballsMoving=!1,document.querySelector(`[data-view='game']`).hidden=!0,document.querySelector(`[data-view='menu']`).hidden=!1,Bu()}function Lu(){Fu($.mode,{difficulty:$.difficulty,raceTo:$.raceTo})}function Ru(e){return{cpu:`
      ...
      <button class="modal-primary" type="button" data-action="start-cpu">START MATCH <span>→</span></button>`,multiplayer:`
      ...
      <small class="modal-note"><i></i> Private room setup is ready for shared-table play.</small>`,room:`
      <p class="modal-eyebrow">PRIVATE TABLE</p>
      <h2 id="modal-title">Room <span class="code-accent">${$.roomCode}</span></h2>
      <p class="modal-intro">Share this code with Player 2. The rack is ready and both players keep the same table view.</p>
      <div class="room-code-display"><span>${$.roomCode}</span><button type="button" data-action="copy-room">COPY</button></div>
      <div class="waiting-row"><i></i><span>Table ready</span><b>2 PLAYERS</b></div>
      <button class="modal-primary" type="button" data-action="start-multiplayer">START TABLE <span>→</span></button>`,howTo:`
      ...
      <button class="modal-primary" type="button" data-action="solo">PRACTICE THE SHOT <span>→</span></button>`,stats:`
      <p class="modal-eyebrow">PLAYER CARD</p>
      <h2 id="modal-title">Your table record.</h2>
      <div class="stats-grid">
        <article><strong>${$.matches}</strong><span>RACKS PLAYED</span></article>
        <article><strong>${$.wins[0]}</strong><span>RACKS WON</span></article>
        <article><strong>${$.longestRun}</strong><span>BEST RUN</span></article>
      </div>
      <p class="modal-intro">Progress is saved automatically on this device.</p>
      <button class="modal-primary" type="button" data-action="close-modal">BACK TO TABLE <span>→</span></button>`,settings:`
      <p class="modal-eyebrow">SETTINGS</p>
      <h2 id="modal-title">Tune your table.</h2>
      <div class="settings-list">
        <button type="button" data-action="sound"><span><strong>Sound effects</strong><small>Cue, rail, collision, and pocket audio</small></span><b data-setting-sound>${$.sound?`ON`:`OFF`}</b></button>
      ...
      <button class="modal-primary" type="button" data-action="close-modal">SAVE SETTINGS <span>→</span></button>`}[e]}function zu(e){let t=document.querySelector(`[data-modal]`);document.querySelector(`[data-modal-content]`).innerHTML=Ru(e),t.hidden=!1,requestAnimationFrame(()=>t.classList.add(`open`))}function Bu(){let e=document.querySelector(`[data-modal]`);e.classList.remove(`open`),e.hidden=!0}function Vu(){$.spin={x:0,y:0};let e=document.querySelector(`[data-spin-dot]`);e&&(e.style.transform=`translate(-50%, -50%)`);let t=document.querySelector(`[data-spin-label]`);t&&(t.textContent=`CENTER`)}function Hu(e){let t=document.querySelector(`[data-spin-control]`),n=document.querySelector(`[data-spin-dot]`),r=t.getBoundingClientRect(),i=r.width*.32,a=e.clientX-(r.left+r.width/2),o=e.clientY-(r.top+r.height/2),s=Math.hypot(a,o);s>i&&(a=a/s*i,o=o/s*i),$.spin={x:a/i,y:-o/i},n.style.transform=`translate(calc(-50% + ${a}px), calc(-50% + ${o}px))`;let c=$.spin.y>.35?`TOP`:$.spin.y<-.35?`DRAW`:``,l=$.spin.x>.35?`RIGHT`:$.spin.x<-.35?`LEFT`:``;document.querySelector(`[data-spin-label]`).textContent=[c,l].filter(Boolean).join(` + `)||`CENTER`}var Uu=document.querySelector(`[data-spin-control]`),Wu=!1;Uu.addEventListener(`pointerdown`,e=>{Wu=!0,Uu.setPointerCapture?.(e.pointerId),Hu(e)}),Uu.addEventListener(`pointermove`,e=>{Wu&&Hu(e)}),Uu.addEventListener(`pointerup`,e=>{Wu=!1,Uu.releasePointerCapture?.(e.pointerId)}),document.addEventListener(`input`,e=>{e.target.id===`room-code`&&(e.target.value=bl(e.target.value))}),document.addEventListener(`click`,async e=>{let t=e.target.closest(`[data-action], [data-difficulty], [data-race]`);if(!t)return;let n=t.dataset.action;if(Fl.click(),t.dataset.difficulty){document.querySelectorAll(`[data-difficulty]`).forEach(e=>e.classList.remove(`selected`)),t.classList.add(`selected`),$.difficulty=t.dataset.difficulty;return}if(t.dataset.race){document.querySelectorAll(`[data-race]`).forEach(e=>e.classList.remove(`selected`)),t.classList.add(`selected`),$.raceTo=Number(t.dataset.race);return}({solo:()=>Fu(`solo`),cpu:()=>zu(`cpu`),multiplayer:()=>zu(`multiplayer`),"how-to":()=>zu(`howTo`),stats:()=>zu(`stats`),settings:()=>zu(`settings`),"close-modal":Bu,"start-cpu":()=>Fu(`cpu`,{difficulty:$.difficulty,raceTo:$.raceTo}),"host-room":()=>{$.roomCode=xl(),zu(`room`)},"join-room":()=>{let e=bl(document.querySelector(`#room-code`)?.value);if(e.length!==6){zl(`Enter a complete 6-character room code`);return}$.roomCode=e,zu(`room`)},"copy-room":async()=>{try{await navigator.clipboard.writeText($.roomCode),zl(`Room code copied`)}catch{zl(`Room code: ${$.roomCode}`)}},"start-multiplayer":()=>Fu(`multiplayer`),"exit-game":Iu,replay:Lu,rerack:Lu,sound:()=>{$.sound=!$.sound,Ll();let e=document.querySelector(`[data-setting-sound]`);e&&(e.textContent=$.sound?`ON`:`OFF`),Il(),$.sound&&Fl.tone(520,.08,`sine`,.03)}})[n]?.()}),document.querySelector(`[data-modal]`).addEventListener(`click`,e=>{e.target.matches(`[data-modal]`)&&Bu()}),window.addEventListener(`keydown`,e=>{e.key===`Escape`&&(document.querySelector(`[data-modal]`).hidden?document.querySelector(`[data-view='game']`).hidden||Iu():Bu()),e.key.toLowerCase()===`r`&&!document.querySelector(`[data-view='game']`).hidden&&Lu()}),Ll(),Kl();