      ...
      <div class="menu-grid">
        ...
        <nav class="mode-menu" aria-label="Choose a game mode">
          ...
          <button class="tutorial-callout" type="button" data-action="tutorial">
            ...
            <span class="mode-copy"><small data-tutorial-menu-kicker>${$.tutorialComplete?`LESSONS COMPLETE`:`NEW PLAYER? START HERE`}</small><strong>GUIDED TUTORIAL</strong><em>Aim • Power • Banks • Spin</em></span>
            <span class="tutorial-callout-status" data-tutorial-menu-status>${$.tutorialComplete?`REPLAY`:`5 LESSONS`}</span>
...
`;var Ll=new class{constructor(){this.context=null,this.lastCollision=0}tone(e,t=.08,n=`sine`,r=.035,i=0){if(!$.sound)return;this.context||=new AudioContext;let a=this.context.currentTime+i,o=this.context.createOscillator(),s=this.context.createGain();o.type=n,o.frequency.setValueAtTime(e,a),s.gain.setValueAtTime(r,a),s.gain.exponentialRampToValueAtTime(1e-4,a+t),o.connect(s).connect(this.context.destination),o.start(a),o.stop(a+t)}click(){this.tone(360,.045,`square`,.02)}strike(e){this.tone(120+e*.8,.1,`triangle`,.065),this.tone(72,.16,`sine`,.025,.015)}collide(e=1){let t=performance.now();t-this.lastCollision<42||(this.lastCollision=t,this.tone(620+Math.min(e,8)*42,.035,`sine`,.016))}rail(){this.tone(185,.05,`triangle`,.017)}pocket(){this.tone(90,.14,`sine`,.055),this.tone(55,.2,`triangle`,.025,.035)}win(){[392,523,659,784].forEach((e,t)=>this.tone(e,.22,`triangle`,.045,t*.085))}};function Rl(){localStorage.setItem(Pl,JSON.stringify({sound:$.sound,wins:$.wins,matches:$.matches,longestRun:$.longestRun,difficulty:$.difficulty,raceTo:$.raceTo,tutorialComplete:$.tutorialComplete}))}function zl(){document.querySelectorAll(`[data-sound-icon]`).forEach(e=>{e.textContent=$.sound?`♪`:`×`})}var Bl;function Vl(e){let t=document.querySelector(`[data-toast]`);t.textContent=e,t.classList.add(`visible`),clearTimeout(Bl),Bl=setTimeout(()=>t.classList.remove(`visible`),2500)}var Hl={0:16249567,1:16238900,2:2058454,3:14893623,4:7161258,5:15894319,6:2071657,7:8267318,8:1120295,9:16238900,10:2058454,11:14893623,12:7161258,13:15894319,14:2071657,15:8267318};function Ul(e,t){let n=document.createElement(`canvas`);n.width=256,n.height=256;let r=n.getContext(`2d`);r.clearRect(0,0,256,256),e>8?(r.fillStyle=`#f8f3df`,r.fillRect(0,0,256,256),r.fillStyle=`#${t.toString(16).padStart(6,`0`)}`,r.fillRect(0,64,256,128)):(r.fillStyle=`#${t.toString(16).padStart(6,`0`)}`,r.fillRect(0,0,256,256)),e!==0&&(r.fillStyle=`#fffdf5`,r.beginPath(),r.arc(128,128,58,0,Math.PI*2),r.fill(),r.fillStyle=`#101725`,r.font=`900 74px Arial`,r.textAlign=`center`,r.textBaseline=`middle`,r.fillText(String(e),128,132));let i=new Ei(n);return i.colorSpace=We,i.anisotropy=4,i}function Wl(e){let t=Hl[e],n=new fn,r=new ri(new Pi(Q.ballRadius,30,20),new Ki({color:t,roughness:.3,metalness:.03}));if(r.castShadow=!0,r.receiveShadow=!0,n.add(r),e>8){let e=new ri(new Fi(Q.ballRadius*.72,Q.ballRadius*.42,12,32),new Ki({color:16315359,roughness:.32}));e.rotation.x=Math.PI/2,n.add(e)}if(e!==0){let r=new Fr(new xr({map:Ul(e,t),transparent:!0,depthTest:!1}));r.scale.set(13,13,1),r.position.y=Q.ballRadius+1.5,n.add(r)}return n}function Gl(e,t,n,r,i=24){let a=new ri(new Ai(t.x,i,t.y),new Ki({color:r,roughness:.55,metalness:.04}));return a.position.set(n.x,n.y,n.z),a.castShadow=!0,a.receiveShadow=!0,e.add(a),a}function Kl(e){Gl(e,{x:1050,y:570},{x:0,y:-22,z:0},5974040,38),Gl(e,{x:1018,y:538},{x:0,y:-4,z:0},12413487,23),Gl(e,{x:960,y:480},{x:0,y:5,z:0},752213,10);let t=new Ki({color:8140062,roughness:.5});[[0,17,-250,884,27],[0,17,250,884,27],[-490,17,0,27,404],[490,17,0,27,404]].forEach(([n,r,i,a,o])=>{let s=new ri(new Ai(a,24,o),t);s.position.set(n,r,i),s.castShadow=!0,e.add(s)}),[[-480,-240],[0,-240],[480,-240],[-480,240],[0,240],[480,240]].forEach(([t,n])=>{let r=new ri(new ji(29,34,8,40),new Ki({color:198410,roughness:.9}));r.position.set(t,13,n),e.add(r)}),[-360,-240,-120,120,240,360].forEach(t=>{[-268,268].forEach(n=>{let r=new ri(new ji(2.3,2.3,2,12),new Ki({color:16173132}));r.position.set(t,30,n),e.add(r)})})}function ql(e,t,n){let r=new hl({canvas:e,antialias:!0,alpha:!0,powerPreference:`high-performance`});return r.outputColorSpace=We,r.shadowMap.enabled=!0,r.shadowMap.type=1,{renderer:r,resize:()=>{let t=e.getBoundingClientRect(),i=Math.max(1,Math.floor(t.width)),a=Math.max(1,Math.floor(t.height)),o=Math.min(window.devicePixelRatio||1,2);(e.width!==i*o||e.height!==a*o)&&(r.setPixelRatio(o),r.setSize(i,a,!1),n.isPerspectiveCamera&&(n.aspect=i/a,n.updateProjectionMatrix()))},scene:t,camera:n}}function Jl(){let e=document.querySelector(`#menu-canvas`),t=new xn;t.fog=new bn(399141,.0019);let n=new Ta(38,1,.1,2200);n.position.set(210,470,620),n.lookAt(80,0,0);let r=new pa(9886207,598041,2.4);t.add(r);let i=new Aa(16771260,4.2);i.position.set(-280,500,300),i.castShadow=!0,t.add(i);let a=new Da(2590719,95,900);a.position.set(400,130,-190),t.add(a);let o=new fn;t.add(o),Kl(o),o.rotation.y=-.1,o.position.set(115,-44,-60);let s=[0,1,2,3,4,5,6,8,9,10,11,12,13,14,15].map((e,t)=>{let n=Wl(e),r=Math.floor(t/5),i=t%5;return n.position.set(80+r*26+i*2,24,(i-2)*26+r*10),o.add(n),n}),c=new ri(new ji(3,5,470,14),new Ki({color:15386762,roughness:.42}));c.rotation.z=Math.PI/2,c.rotation.x=-.22,c.position.set(-160,68,112),o.add(c);let l=ql(e,t,n),u=0,d=e=>{requestAnimationFrame(d),l.resize(),u=e*25e-5,o.rotation.y=-.1+Math.sin(u)*.012,s.forEach((e,t)=>{e.rotation.x+=t%3*7e-4,e.rotation.z+=5e-4}),l.renderer.render(t,n)};requestAnimationFrame(d)}var Yl,Xl,Zl=[],Ql,$l,eu,tu,nu=performance.now(),ru,iu=!1,au=[{x:Q.inset,y:Q.inset},{x:Q.width/2,y:Q.inset},{x:Q.width-Q.inset,y:Q.inset},{x:Q.inset,y:Q.height-Q.inset},{x:Q.width/2,y:Q.height-Q.inset},{x:Q.width-Q.inset,y:Q.height-Q.inset}];function ou(e,t=19){return new K(e.x-Q.width/2,t,e.y-Q.height/2)}function su(e){if(!Xl)return null;let t=Xl.renderer.domElement.getBoundingClientRect(),n=new G((e.clientX-t.left)/t.width*2-1,-((e.clientY-t.top)/t.height)*2+1),r=new Ja;r.setFromCamera(n,Xl.camera);let i=new K;return r.ray.intersectPlane(new ui(new K(0,1,0),-18),i)?{x:i.x+Q.width/2,y:i.z+Q.height/2}:null}function cu(e,t=!1){let n=new Ci(new hr().setFromPoints([new K,new K]),t?new Yi({color:e,dashSize:12,gapSize:8,linewidth:3,transparent:!0,opacity:.95}):new hi({color:e,transparent:!0,opacity:.95}));return n.visible=!1,n.renderOrder=8,Xl.scene.add(n),n}function lu(e,t){if(!t||t.length<2){e.visible=!1;return}e.geometry.dispose(),e.geometry=new hr().setFromPoints(t.map(e=>ou(e,24))),e.computeLineDistances(),e.visible=!0}function uu(e,t,n,r){let i=e.x-n.x,a=e.y-n.y,o=-(i*t.x+a*t.y);if(o<=0)return null;let s=i*i+a*a-o*o,c=r*r;return s>c?null:o-Math.sqrt(c-s)}function du(e,t){let n={left:Q.inset+Q.ballRadius,right:Q.width-Q.inset-Q.ballRadius,top:Q.inset+Q.ballRadius,bottom:Q.height-Q.inset-Q.ballRadius},r=[{...e}],i={...e},a={...t},o=[],s=null;for(let e=0;e<=3;e+=1){let t=a.x>0?(n.right-i.x)/a.x:a.x<0?(n.left-i.x)/a.x:1/0,c=a.y>0?(n.bottom-i.y)/a.y:a.y<0?(n.top-i.y)/a.y:1/0,l=Math.min(t,c),u=null;if(Zl.forEach(e=>{if(e.number===0||e.potted)return;let t=uu(i,a,e.body.position,Q.ballRadius*2.05);t!==null&&t<l&&t>1&&(!u||t<u.distance)&&(u={entry:e,distance:t})}),u){s={x:i.x+a.x*u.distance,y:i.y+a.y*u.distance},r.push(s);let e=u.entry.body.position,t={x:e.x-s.x,y:e.y-s.y},c=Math.hypot(t.x,t.y)||1;t.x/=c,t.y/=c;let l=Math.min(t.x>0?(n.right-e.x)/t.x:(n.left-e.x)/t.x,t.y>0?(n.bottom-e.y)/t.y:(n.top-e.y)/t.y),d=Math.min(155,Math.abs(l));o=[{x:e.x,y:e.y},{x:e.x+t.x*d,y:e.y+t.y*d}];break}let d={x:yl(i.x+a.x*l,n.left,n.right),y:yl(i.y+a.y*l,n.top,n.bottom)};if(r.push(d),e===3)break;Math.abs(t-l)<.001&&(a={...a,x:-a.x}),Math.abs(c-l)<.001&&(a={...a,y:-a.y}),i={x:d.x+a.x*.01,y:d.y+a.y*.01}}return{points:r,objectPath:o,impact:s}}function fu(){let e=Zl.find(e=>e.number===0&&!e.potted);if(!e||!$.aiming){Ql&&(Ql.visible=!1),$l&&($l.visible=!1),eu&&(eu.visible=!1),tu&&(tu.visible=!1);return}let t=du(e.body.position,$.direction);lu(Ql,t.points),lu($l,t.objectPath),t.impact?(eu.position.copy(ou(t.impact,25)),eu.visible=!0):eu.visible=!1;let n=Math.atan2($.direction.y,$.direction.x),r=145+$.power*.55;tu.position.copy(ou({x:e.body.position.x-$.direction.x*r,y:e.body.position.y-$.direction.y*r},33)),tu.rotation.y=-n,tu.visible=!0,document.querySelector(`[data-angle-value]`).textContent=String(Tl($.direction))}function pu(){if(Xl)return;let e=document.querySelector(`#table-canvas`),t=new xn;t.background=new Y(399394);let n=new Oa(-540,540,300,-300,1,1400);n.position.set(0,780,.01),n.lookAt(0,0,0),t.add(new pa(13103103,598291,2.7));let r=new Aa(16772549,3.6);r.position.set(-280,580,260),r.castShadow=!0,r.shadow.mapSize.set(1024,1024),r.shadow.camera.left=-560,r.shadow.camera.right=560,r.shadow.camera.top=320,r.shadow.camera.bottom=-320,t.add(r);let i=new Da(2985215,42,780);i.position.set(450,120,-250),t.add(i),Kl(t),Xl=ql(e,t,n),Ql=cu(16777215,!0),$l=cu(16173132,!1),eu=new ri(new Ni(14,18,32),new Gr({color:16173132,transparent:!0,opacity:.95,side:2})),eu.rotation.x=-Math.PI/2,eu.visible=!1,eu.renderOrder=9,t.add(eu),tu=new ri(new ji(3.1,5.1,270,12),new Ki({color:15255177,roughness:.38})),tu.rotation.z=Math.PI/2,tu.castShadow=!0,tu.visible=!1,t.add(tu),e.addEventListener(`pointerdown`,Ou),e.addEventListener(`pointermove`,ku),e.addEventListener(`pointerup`,ju),e.addEventListener(`pointercancel`,Mu);let a=e=>{requestAnimationFrame(a),Xl.resize();let r=yl(e-nu,8,32);if(nu=e,Yl){let e=Math.ceil(r/16.667);for(let t=0;t<e;t+=1)jl.update(Yl,r/e),bu();_u(),gu(),yu()}fu(),Xl.renderer.render(t,n)};requestAnimationFrame(a)}function mu(){Yl&&jl.clear(Yl),Zl.forEach(e=>{e.mesh.removeFromParent(),e.mesh.traverse(e=>{e.geometry?.dispose?.(),e.material?.map&&e.material.map.dispose(),e.material?.dispose?.()})}),Zl=[],Yl=jl.create({gravity:{x:0,y:0,scale:0}}),Yl.positionIterations=12,Yl.velocityIterations=10;let e={isStatic:!0,restitution:.92,friction:.02,label:`rail`},t=[Ol.rectangle(Q.width/2,29,Q.width-108,25,e),Ol.rectangle(Q.width/2,Q.height-29,Q.width-108,25,e),Ol.rectangle(29,Q.height/2,25,Q.height-108,e),Ol.rectangle(Q.width-29,Q.height/2,25,Q.height-108,e)];Al.add(Yl.world,t);let n={x:264,y:Q.height/2};hu(0,n.x,n.y);let r=Cl();wl().forEach((e,t)=>{hu(r[t],e.x,e.y)}),Ml.on(Yl,`collisionStart`,e=>{e.pairs.forEach(e=>{let t=Zl.find(t=>t.body===e.bodyA),n=Zl.find(t=>t.body===e.bodyB);if(t&&n){let e=Math.max(t.body.speed,n.body.speed);Ll.collide(e),!$.firstHit&&(t.number===0||n.number===0)&&($.firstHit=t.number===0?n.number:t.number,iu=!0)}else(t||n)&&Math.max(e.bodyA.speed,e.bodyB.speed)>1.2&&Ll.rail()})}),Ml.on(Yl,`collisionEnd`,()=>{iu=!1})}function hu(e,t,n){let r=Ol.circle(t,n,Q.ballRadius,{label:`ball-${e}`,restitution:.965,friction:.003,frictionAir:.0125,density:.002,slop:.05}),i=Wl(e);Xl.scene.add(i),Zl.push({number:e,body:r,mesh:i,potted:!1}),Al.add(Yl.world,r)}function gu(){Zl.forEach(e=>{e.potted||(e.mesh.position.copy(ou(e.body.position,Q.ballRadius+17)),e.body.speed>.02&&(e.mesh.rotation.z-=e.body.velocity.x*.018,e.mesh.rotation.x+=e.body.velocity.y*.018))})}function _u(){Zl.forEach(e=>{e.potted||au.find(t=>Math.hypot(e.body.position.x-t.x,e.body.position.y-t.y)<Q.pocketRadius)&&(e.potted=!0,e.mesh.visible=!1,Al.remove(Yl.world,e.body),Ll.pocket(),e.number===0?($.shotPotted.push(0),Vl(`Scratch • Cue ball returns after the shot`)):($.shotPotted.push(e.number),$.currentRun+=1,$.longestRun=Math.max($.longestRun,$.currentRun),e.number===8&&Ru()),Vu())})}function vu(){return Zl.filter(e=>!e.potted).every(e=>e.body.speed<.085)}function yu(){if(!(!$.ballsMoving||$.gameOver)){if(!vu()){$.settling=!1;return}$.settling||($.settling=!0,setTimeout(()=>{$.ballsMoving&&vu()&&!$.gameOver&&Lu(),$.settling=!1},320))}}function bu(){if($.spinFrames<=0)return;let e=Zl.find(e=>e.number===0&&!e.potted);if(!e||e.body.speed<.15){$.spinFrames=0;return}let t=Math.hypot(e.body.velocity.x,e.body.velocity.y)||1,n={x:-e.body.velocity.y/t,y:e.body.velocity.x/t},r=$.spin.x*9e-6*Math.min(e.body.speed,12);if(kl.applyForce(e.body,e.body.position,{x:n.x*r,y:n.y*r}),iu&&$.spin.y!==0){let t=1+$.spin.y*.0018;kl.setVelocity(e.body,{x:e.body.velocity.x*t,y:e.body.velocity.y*t})}--$.spinFrames}function xu(){let e=document.querySelector(`[data-tutorial-menu-kicker]`),t=document.querySelector(`[data-tutorial-menu-status]`);e&&(e.textContent=$.tutorialComplete?`LESSONS COMPLETE`:`NEW PLAYER? START HERE`),t&&(t.textContent=$.tutorialComplete?`REPLAY`:`5 LESSONS`)}function Su(){if(!$.aiming)return 0;let e=Zl.find(e=>e.number===0&&!e.potted);if(!e)return 0;let t=du(e.body.position,$.direction);return Math.max(0,t.points.length-2)}function Cu(){if($.mode!==`tutorial`||$.tutorialStep>=5)return;let e=Math.hypot($.spin.x,$.spin.y),t=vl($.tutorialStep,{aiming:$.aiming,power:$.power,spinMagnitude:e,bankBounces:Su()});t!==$.tutorialReady&&($.tutorialReady=t,wu())}function wu(){let e=document.querySelector(`[data-tutorial-panel]`),t=document.querySelector(`[data-view='game']`);if(!e||!t)return;let n=$.mode===`tutorial`;if(e.hidden=!n,t.classList.toggle(`tutorial-mode`,n),!n){delete t.dataset.tutorialTarget;return}let r=$.tutorialStep>=5,i=r?{kicker:`TUTORIAL COMPLETE`,title:`You own the basics`,copy:`You aimed, set power, applied English, and played a readable bank shot. The full table is yours now.`,tip:`Continue in free practice, challenge the CPU, or open a private table.`,target:`none`,action:`FREE PRACTICE`}:Il[$.tutorialStep];t.dataset.tutorialTarget=i.target,document.querySelector(`[data-tutorial-kicker]`).textContent=i.kicker,document.querySelector(`[data-tutorial-title]`).textContent=i.title,document.querySelector(`[data-tutorial-copy]`).textContent=i.copy,document.querySelector(`[data-tutorial-tip]`).textContent=i.tip;let a=document.querySelector(`[data-tutorial-progress]`);a.innerHTML=Array.from({length:5},(e,t)=>`<i class="${t<$.tutorialStep?`complete`:t===$.tutorialStep?`current`:``}" aria-hidden="true"></i>`).join(``),a.setAttribute(`aria-label`,r?`Tutorial complete`:`Lesson ${$.tutorialStep+1} of 5`);let o=document.querySelector(`[data-action='tutorial-back']`),s=document.querySelector(`[data-action='tutorial-skip']`),c=document.querySelector(`[data-action='tutorial-next']`);o.hidden=r,o.disabled=$.tutorialStep===0,s.textContent=r?`MAIN MENU`:`SKIP`,c.disabled=!r&&(!$.tutorialReady||$.tutorialStep===4),c.classList.toggle(`ready`,r||$.tutorialReady);let l=$.tutorialStep===4&&$.tutorialReady?`RELEASE TO SHOOT`:i.action;document.querySelector(`[data-tutorial-action]`).textContent=l}function Tu(){if($.mode===`tutorial`){if($.tutorialStep>=5){Uu(`solo`),Vl(`Tutorial complete • Free practice unlocked`);return}!$.tutorialReady||$.tutorialStep===4||(Mu(),$.tutorialStep+=1,$.tutorialReady=vl($.tutorialStep),$.tutorialStep===3&&Yu(),Hu(),wu())}}function Eu(){$.mode!==`tutorial`||$.tutorialStep<=0||$.tutorialStep>=5||(Mu(),--$.tutorialStep,$.tutorialReady=vl($.tutorialStep),Hu(),wu())}function Du(){return!($.gameOver||$.ballsMoving||$.aiming||$.mode===`cpu`&&$.currentPlayer===1||$.mode===`tutorial`&&![1,2,4].includes($.tutorialStep))}function Ou(e){if(!Du())return;let t=su(e),n=Zl.find(e=>e.number===0&&!e.potted);!t||!n||(e.currentTarget.setPointerCapture?.(e.pointerId),$.aiming=!0,$.power=0,Au(t),document.querySelector(`[data-turn-banner]`).classList.add(`aiming`),Cu())}function ku(e){if(!$.aiming)return;let t=su(e);t&&Au(t)}function Au(e){let t=Zl.find(e=>e.number===0&&!e.potted);if(!t)return;let n={x:t.body.position.x-e.x,y:t.body.position.y-e.y},r=Math.hypot(n.x,n.y);r>2&&($.direction={x:n.x/r,y:n.y/r}),$.power=Math.round(yl(r/190*100,0,100)),document.querySelector(`[data-power-value]`).textContent=String($.power),document.querySelector(`[data-power-fill]`).style.height=`${$.power}%`,Cu()}function ju(e){if(!$.aiming)return;e.currentTarget.releasePointerCapture?.(e.pointerId),document.querySelector(`[data-turn-banner]`).classList.remove(`aiming`);let t=$.power;if($.aiming=!1,$.mode===`tutorial`&&$.tutorialStep<4){let e=$.tutorialReady;Mu(),$.tutorialReady=e,wu();return}if($.mode===`tutorial`&&$.tutorialStep===4&&!$.tutorialReady){Mu(),Vl(`Aim for a rail bounce and pull to at least 35%`),wu();return}if(t<4){$.power=0,document.querySelector(`[data-power-value]`).textContent=`0`,document.querySelector(`[data-power-fill]`).style.height=`0%`;return}Nu($.direction,t)}function Mu(){$.aiming=!1,$.power=0,document.querySelector(`[data-power-value]`).textContent=`0`,document.querySelector(`[data-power-fill]`).style.height=`0%`}function Nu(e,t){let n=Zl.find(e=>e.number===0&&!e.potted);if(!n||$.ballsMoving||$.gameOver)return;clearTimeout(ru),$.aiming=!1,$.shotPotted=[],$.firstHit=null,$.power=t,$.shotNumber+=1,$.spinFrames=115,$.ballsMoving=!0,$.settling=!1;let r=5.1+t*.195;kl.setVelocity(n.body,{x:e.x*r,y:e.y*r}),Ll.strike(t),document.querySelector(`[data-shot-number]`).textContent=String($.shotNumber).padStart(2,`0`),document.querySelector(`[data-table-status]`).textContent=`BALLS IN MOTION`,document.querySelector(`[data-turn-banner]`).textContent=`SHOT PLAYING`,document.querySelector(`[data-power-value]`).textContent=`0`,document.querySelector(`[data-power-fill]`).style.height=`0%`}function Pu(e){return Zl.filter(t=>!t.potted&&bl(t.number)===e).length}function Fu(){if($.breakShot||$.groups[0]||$.groups[1])return;let e=$.shotPotted.find(e=>bl(e));if(!e)return;let t=bl(e);$.groups[$.currentPlayer]=t,$.groups[1-$.currentPlayer]=Dl(t),Vl(`${$.currentPlayer===0?`Player 1`:`Player 2`} takes ${t}`)}function Iu(){let e=Zl.find(e=>e.number===0);e?.potted&&(e.potted=!1,e.mesh.visible=!0,kl.setPosition(e.body,{x:264,y:Q.height/2}),kl.setVelocity(e.body,{x:0,y:0}),Al.add(Yl.world,e.body))}function Lu(){if($.ballsMoving=!1,$.mode===`tutorial`&&$.tutorialStep===4){Iu(),$.tutorialStep=5,$.tutorialReady=!0,$.tutorialComplete=!0,$.power=0,Rl(),xu(),Hu(),wu(),Ll.win(),Vl(`Tutorial complete • Precision unlocked`);return}let e=$.breakShot;$.breakShot=!1,Iu(),e||Fu();let t=$.groups[$.currentPlayer];!($.mode===`solo`||e&&$.shotPotted.some(e=>bl(e))||$.shotPotted.some(e=>bl(e)===t))&&$.mode!==`solo`&&($.currentRun=0,$.currentPlayer=1-$.currentPlayer),e&&Vl(`Table open • First legal pot claims a group`),$.power=0,Hu(),$.mode===`cpu`&&$.currentPlayer===1&&zu()}function Ru(){if($.mode===`tutorial`)return;let e=El({pottedNumber:8,playerGroup:$.groups[$.currentPlayer],remainingGroupBalls:Pu($.groups[$.currentPlayer])}),t=e===`win`?$.currentPlayer:1-$.currentPlayer;$.wins[t]+=1,$.matches+=1,$.gameOver=!0,$.ballsMoving=!1,Rl(),Ll.win();let n=document.querySelector(`[data-result-card]`);n.hidden=!1,document.querySelector(`[data-result-kicker]`).textContent=e===`win`?`CLEAN FINISH`:`EARLY EIGHT`,document.querySelector(`[data-result-title]`).textContent=$.mode===`solo`?e===`win`?`TABLE CLEARED`:`RACK ENDED`:`${t===0?`PLAYER 1`:$.mode===`cpu`?`CPU`:`PLAYER 2`} WINS`,document.querySelector(`[data-result-copy]`).textContent=e===`win`?`The eight dropped on a legal table. Champion work.`:`The eight went early. Re-rack and read the finish.`,Hu()}function zu(){clearTimeout(ru),document.querySelector(`[data-table-status]`).textContent=`CPU READING TABLE`,document.querySelector(`[data-turn-banner]`).textContent=`CPU AIMING`;let e={easy:1050,medium:850,hard:680}[$.difficulty];ru=setTimeout(()=>{if($.currentPlayer!==1||$.gameOver||$.ballsMoving)return;let e=Zl.find(e=>e.number===0&&!e.potted),t=$.groups[1],n=Zl.filter(e=>!e.potted&&e.number!==0&&e.number!==8);if(t&&(n=n.filter(e=>bl(e.number)===t)),t&&Pu(t)===0&&(n=Zl.filter(e=>!e.potted&&e.number===8)),!e||!n.length)return;n.sort((t,n)=>Math.hypot(t.body.position.x-e.body.position.x,t.body.position.y-e.body.position.y)-Math.hypot(n.body.position.x-e.body.position.x,n.body.position.y-e.body.position.y));let r=n[0],i=Math.atan2(r.body.position.y-e.body.position.y,r.body.position.x-e.body.position.x),a={easy:.14,medium:.065,hard:.018}[$.difficulty],o=i+(Math.random()-.5)*a;$.direction={x:Math.cos(o),y:Math.sin(o)},$.spin={x:(Math.random()-.5)*.6,y:.2},Nu($.direction,{easy:48,medium:58,hard:66}[$.difficulty])},e)}function Bu(e){return e===_l.SOLIDS?`SOLIDS 1–7`:e===_l.STRIPES?`STRIPES 9–15`:`OPEN TABLE`}function Vu(){let e=document.querySelector(`[data-ball-tray]`);e.innerHTML=Array.from({length:15},(e,t)=>t+1).map(e=>`<span class="tray-ball ball-${e} ${Zl.find(t=>t.number===e)?.potted?`potted`:``}">${e}</span>`).join(``)}function Hu(){let e={tutorial:[`GUIDED TUTORIAL`,$.tutorialStep>=5?`LESSONS COMPLETE`:`LESSON ${$.tutorialStep+1} OF 5`],solo:[`SOLO PRACTICE`,`YOUR TABLE`],cpu:[`VERSUS CPU`,$.currentPlayer===0?`YOUR TURN`:`CPU TURN`],multiplayer:[`MULTIPLAYER`,$.currentPlayer===0?`PLAYER 1 TURN`:`PLAYER 2 TURN`]};document.querySelector(`[data-mode-label]`).textContent=e[$.mode][0],document.querySelector(`[data-turn-label]`).textContent=e[$.mode][1],document.querySelector(`[data-player-two-name]`).textContent=$.mode===`tutorial`?`TABLE COACH`:$.mode===`cpu`?`CPU RIVAL`:`PLAYER 2`,document.querySelector(`[data-player-one-group]`).textContent=Bu($.groups[0]),document.querySelector(`[data-player-two-group]`).textContent=Bu($.groups[1]),document.querySelector(`[data-player-one-score]`).textContent=`P1  ${$.wins[0]}`,document.querySelector(`[data-player-two-score]`).textContent=`${$.mode===`tutorial`?`COACH`:$.mode===`cpu`?`CPU`:`P2`}  ${$.wins[1]}`,document.querySelectorAll(`[data-player-card]`).forEach((e,t)=>{e.classList.toggle(`active`,t===$.currentPlayer)}),document.querySelector(`[data-table-status]`).textContent=$.mode===`tutorial`?$.tutorialStep>=5?`LESSONS COMPLETE`:Il[$.tutorialStep].title.toUpperCase():$.breakShot?`BREAK THE RACK`:$.mode===`solo`?`PRACTICE TABLE`:$.currentPlayer===1&&$.mode===`cpu`?`CPU READING TABLE`:`LINE UP YOUR SHOT`,document.querySelector(`[data-turn-banner]`).textContent=$.mode===`tutorial`?$.tutorialStep>=5?`TUTORIAL COMPLETE`:$.tutorialStep===4?`BANK SHOT`:`COACH MODE`:$.mode===`cpu`&&$.currentPlayer===1?`CPU AIMING`:$.mode===`solo`?`FREE PLAY`:`YOUR SHOT`,Vu()}function Uu(e,t={}){$.mode=e,$.difficulty=t.difficulty||$.difficulty,$.raceTo=t.raceTo||$.raceTo,$.currentPlayer=0,$.groups=[null,null],$.breakShot=!0,$.shotNumber=0,$.shotPotted=[],$.currentRun=0,$.gameOver=!1,$.ballsMoving=!1,$.aiming=!1,$.spin={x:0,y:0},e===`tutorial`&&($.tutorialStep=0,$.tutorialReady=!0),document.querySelector(`[data-result-card]`).hidden=!0,document.querySelector(`[data-shot-number]`).textContent=`01`,document.querySelector(`[data-view='menu']`).hidden=!0,document.querySelector(`[data-view='game']`).hidden=!1,Ju(),pu(),mu(),Hu(),Yu(),wu(),Rl(),requestAnimationFrame(()=>Xl.resize())}function Wu(){clearTimeout(ru),$.aiming=!1,$.ballsMoving=!1,wu(),document.querySelector(`[data-view='game']`).hidden=!0,document.querySelector(`[data-view='menu']`).hidden=!1,Ju()}function Gu(){Uu($.mode,{difficulty:$.difficulty,raceTo:$.raceTo})}function Ku(e){return{cpu:`
      ...
      <button class="modal-primary" type="button" data-action="tutorial">START GUIDED TUTORIAL <span>→</span></button>`,stats:`
      ...
      <button class="modal-primary" type="button" data-action="close-modal">SAVE SETTINGS <span>→</span></button>`}[e]}function qu(e){let t=document.querySelector(`[data-modal]`);document.querySelector(`[data-modal-content]`).innerHTML=Ku(e),t.hidden=!1,requestAnimationFrame(()=>t.classList.add(`open`))}function Ju(){let e=document.querySelector(`[data-modal]`);e.classList.remove(`open`),e.hidden=!0}function Yu(){$.spin={x:0,y:0};let e=document.querySelector(`[data-spin-dot]`);e&&(e.style.transform=`translate(-50%, -50%)`);let t=document.querySelector(`[data-spin-label]`);t&&(t.textContent=`CENTER`)}function Xu(e){let t=document.querySelector(`[data-spin-control]`),n=document.querySelector(`[data-spin-dot]`),r=t.getBoundingClientRect(),i=r.width*.32,a=e.clientX-(r.left+r.width/2),o=e.clientY-(r.top+r.height/2),s=Math.hypot(a,o);s>i&&(a=a/s*i,o=o/s*i),$.spin={x:a/i,y:-o/i},n.style.transform=`translate(calc(-50% + ${a}px), calc(-50% + ${o}px))`;let c=$.spin.y>.35?`TOP`:$.spin.y<-.35?`DRAW`:``,l=$.spin.x>.35?`RIGHT`:$.spin.x<-.35?`LEFT`:``;document.querySelector(`[data-spin-label]`).textContent=[c,l].filter(Boolean).join(` + `)||`CENTER`,Cu()}var Zu=document.querySelector(`[data-spin-control]`),Qu=!1;Zu.addEventListener(`pointerdown`,e=>{Qu=!0,Zu.setPointerCapture?.(e.pointerId),Xu(e)}),Zu.addEventListener(`pointermove`,e=>{Qu&&Xu(e)}),Zu.addEventListener(`pointerup`,e=>{Qu=!1,Zu.releasePointerCapture?.(e.pointerId)}),document.addEventListener(`input`,e=>{e.target.id===`room-code`&&(e.target.value=xl(e.target.value))}),document.addEventListener(`click`,async e=>{let t=e.target.closest(`[data-action], [data-difficulty], [data-race]`);if(!t)return;let n=t.dataset.action;if(Ll.click(),t.dataset.difficulty){document.querySelectorAll(`[data-difficulty]`).forEach(e=>e.classList.remove(`selected`)),t.classList.add(`selected`),$.difficulty=t.dataset.difficulty;return}if(t.dataset.race){document.querySelectorAll(`[data-race]`).forEach(e=>e.classList.remove(`selected`)),t.classList.add(`selected`),$.raceTo=Number(t.dataset.race);return}({tutorial:()=>Uu(`tutorial`),solo:()=>Uu(`solo`),cpu:()=>qu(`cpu`),multiplayer:()=>qu(`multiplayer`),"how-to":()=>qu(`howTo`),stats:()=>qu(`stats`),settings:()=>qu(`settings`),"close-modal":Ju,"start-cpu":()=>Uu(`cpu`,{difficulty:$.difficulty,raceTo:$.raceTo}),"host-room":()=>{$.roomCode=Sl(),qu(`room`)},"join-room":()=>{let e=xl(document.querySelector(`#room-code`)?.value);if(e.length!==6){Vl(`Enter a complete 6-character room code`);return}$.roomCode=e,qu(`room`)},"copy-room":async()=>{try{await navigator.clipboard.writeText($.roomCode),Vl(`Room code copied`)}catch{Vl(`Room code: ${$.roomCode}`)}},"start-multiplayer":()=>Uu(`multiplayer`),"tutorial-back":Eu,"tutorial-next":Tu,"tutorial-skip":()=>{$.tutorialStep>=5?Wu():(Uu(`solo`),Vl(`Tutorial skipped • Free practice is ready`))},"exit-game":Wu,replay:Gu,rerack:Gu,sound:()=>{$.sound=!$.sound,zl();let e=document.querySelector(`[data-setting-sound]`);e&&(e.textContent=$.sound?`ON`:`OFF`),Rl(),$.sound&&Ll.tone(520,.08,`sine`,.03)}})[n]?.()}),document.querySelector(`[data-modal]`).addEventListener(`click`,e=>{e.target.matches(`[data-modal]`)&&Ju()}),window.addEventListener(`keydown`,e=>{e.key===`Escape`&&(document.querySelector(`[data-modal]`).hidden?document.querySelector(`[data-view='game']`).hidden||Wu():Ju()),e.key.toLowerCase()===`r`&&!document.querySelector(`[data-view='game']`).hidden&&Gu()}),zl(),xu(),Jl();